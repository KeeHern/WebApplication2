    ...
    namespace WebApplication2.Pages
    {
        ...
        private readonly IDataProtectionProvider dataProtectionProvider;
            ...
            public async Task<IActionResult> OnPostAsync()
            {
                ...
                {
                    ModelState.AddModelError("", "reCAPTCHA validation was unsuccessful.");
                    return Page();
                }
                ...
                if (LModel.Email != null)
                {
                    ...
                    {
                        ModelState.AddModelError(nameof(LModel.Email), "Please enter a valid email.");
                        return Page();
                    }
                }
                ...
                if (await userManager.IsLockedOutAsync(login_usr))
                {
                    ...
                    {
                        User_Id = protector.Protect(login_usr.Email),
                ...
                if (LModel.Password != null)
                        ...
                        await signInManager.PasswordSignInAsync(login_usr.Email, LModel.Password, false, false);
                        ...
                        else
                        {
                            ...
                            if (await userManager.IsLockedOutAsync(login_usr))
                            {
                            var auditLog1 = new AuditLogs
                            {
                                User_Id = protector.Protect(login_usr.Email),
                                timing = DateTime.UtcNow,
                                tasks = "Account is locked."
                            };
